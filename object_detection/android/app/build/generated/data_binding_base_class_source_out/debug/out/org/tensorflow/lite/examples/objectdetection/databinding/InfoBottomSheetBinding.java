...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout croppedLayout;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      @NonNull NestedScrollView bottomSheetLayout, @NonNull LinearLayout croppedLayout,
      ...
      @NonNull TextView thresholdValue, @NonNull ImageView view5) {
    this.rootView = rootView;
    this.bottomSheetLayout = bottomSheetLayout;
    this.croppedLayout = croppedLayout;
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.cropped_layout;
      LinearLayout croppedLayout = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.view5;
      ImageView view5 = ViewBindings.findChildViewById(rootView, id);
      if (view5 == null) {
        break missingId;
      }

      return new InfoBottomSheetBinding((NestedScrollView) rootView, bottomSheetLayout,
          croppedLayout, inferenceTimeLabel, inferenceTimeVal, maxResultsMinus, maxResultsPlus,
          maxResultsValue, spinnerDelegate, spinnerModel, threadsMinus, threadsPlus, threadsValue,
          thresholdMinus, thresholdPlus, thresholdValue, view5);
    }
